...
var ErrNotUnwrapped = errors.New("something has gone wrong during the registering of this component, please open an issue https://github.com/TykTechnologies/benthos/issues/new to let us know")
